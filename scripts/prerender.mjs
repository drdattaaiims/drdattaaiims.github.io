...
<div id="root">
  <div class="min-h-screen pt-14" data-prerendered-homepage>
      ...
      <div class="mx-auto max-w-[1120px] px-6">
        <div class="flex items-center justify-between h-14">
          ...
          <nav class="hidden items-center gap-4 font-sans text-xs min-[900px]:flex" aria-label="Primary">
            <a href="/research.html">Work</a><a href="/clinical-global-health.html">Clinical &amp; Global Health</a><a href="/publications.html">Publications</a><a href="/journey.html">Journey</a><a href="/cv/">CV</a><a href="/#contact">Contact</a>
          </nav>
        </div>
      </div>
    </header>
    <main>
      ...
      <section class="border-b border-rule bg-elevated px-6 py-10 min-[900px]:py-14"><div class="mx-auto max-w-[1120px]"><h2 class="font-display text-2xl font-semibold text-navy">What counts as evidence</h2><p class="max-w-prose leading-relaxed">Capability, reliability, safety, deployment fit and impact—from retrospective evaluation through workflow testing, prospective validation and post-deployment monitoring.</p></div></section>
